// src/webparts/.../components/Header.tsx
import React from 'react';
import Button from './ui/Button';
import { WebPartContext } from '@microsoft/sp-webpart-base';

type ViewMode = 'monthly' | 'quarterly' | 'half-yearly' | 'yearly';
...
const Header: React.FC<HeaderProps> = ({
  ...
  const modeLabels: { [key in ViewMode]: string } = {
    monthly: 'Monthly',
    quarterly: 'Quarterly',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button onClick={onAddTransaction} variant="secondary">Add Transaction</Button>
            <Button onClick={onAddPurchase} variant="primary">Add Purchase</Button>
          </div>
        </div>
